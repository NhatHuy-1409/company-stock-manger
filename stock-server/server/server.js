...
const electricItems = require("./routers/electric-items")
const electricItemstype = require("./routers/electric-itemsType")
const electricCategories = require("./routers/electric-categories")
const mechanicalItems = require("./routers/mechanical-items")
const mechanicalItemstype = require("./routers/mechanical-itemsType")
const mechanicalCategories = require("./routers/mechanical-categories")
